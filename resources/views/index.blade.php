...
<style>
    ...
    .medicine-checkbox:checked { background-color: #28a745; border-color: #28a745; }
    #select-all-medicines { transform: scale(1.2); cursor: pointer; }
    #select-all-medicines:checked { background-color: #007bff; border-color: #007bff; }
            ...
            <div class="card-body">
                ...
                <div class="mt-4">
                    <ul class="nav nav-tabs" id="templateTabs" role="tablist">
                                                <li class="nav-item">
                            <a class="nav-link active" id="admission-rx-tab" data-toggle="tab" href="#admission-rx" role="tab" data-step="1">
                                <i class="fas fa-hospital-user text-primary"></i> Admission Rx <span class="step-badge badge badge-primary">1</span>
                            </a>
                        </li>
                                                <li class="nav-item">
                            <a class="nav-link disabled" id="pre-op-tab" data-toggle="tab" href="#pre-op" role="tab" data-step="2">
                                <i class="fas fa-procedures text-muted"></i> Pre-operative Order <span class="step-badge badge badge-secondary">2</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link disabled" id="post-op-tab" data-toggle="tab" href="#post-op" role="tab" data-step="3">
                                <i class="fas fa-band-aid text-muted"></i> Post-operative Order <span class="step-badge badge badge-secondary">3</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="fresh-tab" data-toggle="tab" href="#fresh" role="tab" data-step="4">
                                <i class="fas fa-plus-circle text-primary"></i> Fresh Prescription <span class="step-badge badge badge-primary">4</span>
                            </a>
                        </li>
                                                <li class="nav-item">
                            <a class="nav-link disabled" id="discharge-tab" data-toggle="tab" href="#discharge" role="tab" data-step="5">
                                            ...
                                            <div class="card-tools">
                                                <div class="input-group input-group-sm" style="width: 200px;">
                                                    ...
                                                    <div class="input-group-append">
                                                        <button type="button" class="btn btn-default" id="clear-admission-medicine-search" title="Clear search">
                                        ...
                                        <div class="card-body p-0">
                                            <table class="table table-hover medicine-table mb-0">
                                                <thead>
                                                    <tr>
                                                        <th width="40px">
                                                            <input type="checkbox" id="select-all-admission-medicines" title="Select All">
                                                        </th>
                                                        <th>Medicine</th>
                                                        <th>Dosage</th>
                                                        <th>Duration</th>
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <div class="input-group-append">
                                                        <button type="button" class="btn btn-outline-secondary" id="quick-add-medicine" title="Quick Add">
                                                            <i class="fas fa-plus"></i>
                                                        </button>
                                                    </div>
                                                </div>
                                                <small class="form-text text-muted">Search from database or type medicine name and click + for quick entry</small>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                            ...
                                            <button type="button" class="btn btn-warning btn-sm mt-2" onclick="testMedicineSelection()">
                                                <i class="fas fa-bug mr-2"></i>Test Selection
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="card card-outline card-success">
                                        <div class="card-header py-2">
                                            ...
                                            <div class="card-tools">
                                                <div class="input-group input-group-sm" style="width: 200px;">
                                                    <input type="text" class="form-control" id="medicine-search-filter" placeholder="Search medicines...">
                                                    <div class="input-group-append">
                                                        <button type="button" class="btn btn-default" id="clear-medicine-search" title="Clear search">
                                                            <i class="fas fa-times"></i>
                                                        </button>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card-body p-0">
                                            <table class="table table-hover medicine-table mb-0">
                                                <thead>
                                                    <tr>
                                                        <th width="40px">
                                                            <input type="checkbox" id="select-all-medicines" title="Select All">
                                                        </th>
                                                        <th>Medicine</th>
                                                        <th>Dosage</th>
                                                        <th>Duration</th>
                                                ...
                                                <tbody id="medicine-list">
                                                    <tr><td colspan="6" class="text-center text-muted py-3"><i class="fas fa-info-circle mr-2"></i>No medicines added yet</td></tr>
                                                </tbody>
                                            </table>
                                        </div>
                                    </div>
...
$(document).ready(function() {
    ...
    // Replace select2 with text input for combined search/quick entry
    $('#medicine-search').select2('destroy');
    ...
    // Medicine search functionality with autocomplete
        ...
        medicineSearchTimeout = setTimeout(function() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    let medicines = response.data || response || [];
    ...
    $('#quick-add-medicine').on('click', function() {
        let medicineName = $('#medicine-search').val().trim();
        if (!medicineName) { 
            toastr.error('Please enter medicine name'); 
            return; 
        }
        addQuickMedicineFromForm(medicineName);
    });

    // Medicine search filter functionality
    $('#medicine-search-filter').on('input', function() {
        let searchTerm = $(this).val().toLowerCase();
        let $rows = $('#medicine-list tr');
        
        $rows.each(function() {
            let $row = $(this);
            let medicineName = $row.find('td:eq(1)').text().toLowerCase();
            let dosage = $row.find('td:eq(2)').text().toLowerCase();
            let duration = $row.find('td:eq(3)').text().toLowerCase();
            
            if (medicineName.includes(searchTerm) || dosage.includes(searchTerm) || duration.includes(searchTerm)) {
                $row.show();
            } else {
                $row.hide();
            }
    ...
    $(document).on('change', '.medicine-checkbox', function() {
        ...
        console.log(`Checkbox ${index} changed to: ${$(this).is(':checked')}`);
        medicines[index].selected = $(this).is(':checked');
        console.log(`Updated medicine[${index}].selected to: ${medicines[index].selected}`);
        
        // Update select all checkbox state
        let allChecked = medicines.every(med => med.selected);
        let anyChecked = medicines.some(med => med.selected);
        $('#select-all-medicines').prop('checked', allChecked);
        $('#select-all-medicines').prop('indeterminate', anyChecked && !allChecked);
    });

    // Admission medicine checkbox event handlers
    $('#select-all-admission-medicines').on('change', function() {
        let isChecked = $(this).is(':checked');
        $('.admission-medicine-checkbox').prop('checked', isChecked);
        admissionMedicines.forEach((med, index) => {
            med.selected = isChecked;
        });
    });
    ...
    $(document).on('change', '.admission-medicine-checkbox', function() {
        let index = $(this).data('index');
        console.log(`=== ADMISSION CHECKBOX CHANGE ===`);
        console.log(`Admission Checkbox ${index} changed to: ${$(this).is(':checked')}`);
        admissionMedicines[index].selected = $(this).is(':checked');
        console.log(`Updated admissionMedicine[${index}].selected to: ${admissionMedicines[index].selected}`);
        
        // Update select all checkbox state
        let allChecked = admissionMedicines.every(med => med.selected);
        let anyChecked = admissionMedicines.some(med => med.selected);
        $('#select-all-admission-medicines').prop('checked', allChecked);
        $('#select-all-admission-medicines').prop('indeterminate', anyChecked && !allChecked);
    });
...
function loadTemplates() {
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#fresh-template-select').html(options).trigger('change');
        },
...
function loadSelectedTemplate() {
    // Determine which tab is active and use the appropriate dropdown
    let $templateSelect, $doctorSelect;
    
    if ($('#fresh').hasClass('active')) {
        // Fresh Prescription tab is active
        $templateSelect = $('#fresh-template-select');
        $doctorSelect = $('#doctor-select');
    } else {
        // Admission Rx tab is active
    ...
    // Doctor is optional for Admission Rx, required for Fresh Prescription
    let isFreshTab = $('#fresh').hasClass('active');
    let doctorId = $doctorSelect.val();
    if (isFreshTab && !doctorId) { toastr.error('Please select a doctor'); return; }
    ...
    let doctorOption = $doctorSelect.find('option:selected');
...
function populateTemplateData(response, surgeryType) {
    ...
    if (response.medicines?.length) { 
        medicines = response.medicines.map(med => ({...med, selected: true})); 
        updateMedicineList(); 
        // Ensure checkboxes are checked after template load
        setTimeout(() => {
            $('.medicine-checkbox').prop('checked', true);
            // Update select all checkbox state
            $('#select-all-medicines').prop('checked', true);
            $('#select-all-medicines').prop('indeterminate', false);
        }, 100);
        itemCount += response.medicines.length; 
    }
    if (response.admission_medicines?.length) { 
        admissionMedicines = response.admission_medicines.map(med => ({...med, selected: true})); 
        updateAdmissionMedicineList(); 
        // Ensure checkboxes are checked after template load
        setTimeout(() => {
            $('.admission-medicine-checkbox').prop('checked', true);
            // Update select all checkbox state
            $('#select-all-admission-medicines').prop('checked', true);
            $('#select-all-admission-medicines').prop('indeterminate', false);
        }, 100);
        itemCount += response.admission_medicines.length; 
    }
...
function addMedicine() {
    let medicineName = $('#medicine-search').val().trim();
    if (!medicineName) { toastr.error('Please enter medicine name'); return; }
    
    let medData = {
        template_medicine_id: Date.now(),
        name: medicineName,
        strength: '',
        brand: 'Manual Entry',
        dosage: $('#dosage').val() || '1+0+1',
        duration: $('#duration').val() || '7 days',
        order_type: $('#order-type').val() || 'pre-op',
        route: $('#route').val() || 'Oral',
        frequency: $('#frequency').val(),
        medicine_type: $('#medicine-type').val() || 'Tablet',
...
function addQuickMedicineFromForm(medicineName) {
    let medData = {
        template_medicine_id: Date.now(),
        name: medicineName,
        strength: '',
    ...
    updateMedicineList();
    $('#medicine-search').val('');
    toastr.success('Quick medicine added: ' + medicineName);
}

function clearMedicineForm() {
    $('#medicine-search').val('');
    $('#duration').val(''); 
    $('#medicine-instruction').val(''); 
    $('#frequency').val('');
}

function testMedicineSelection() {
    alert('Test button clicked! Total medicines: ' + medicines.length);
    console.log('=== Medicine Selection Test ===');
    console.log('Total medicines:', medicines.length);
    console.log('Medicines array:', medicines);
    
    let selectedMeds = medicines.filter(med => med.selected);
    console.log('Selected medicines:', selectedMeds.length);
    console.log('Selected medicines array:', selectedMeds);
    
    // Check checkbox states
    let checkboxes = $('.medicine-checkbox');
    console.log('Checkboxes found:', checkboxes.length);
    checkboxes.each(function(index) {
        console.log(`Checkbox ${index}: checked=${$(this).is(':checked')}, data-index=${$(this).data('index')}`);
    });
    
    toastr.info(`Total: ${medicines.length}, Selected: ${selectedMeds.length}. Check console for details.`);
}

function updateMedicineList() {
    let selectedCount = medicines.filter(med => med.selected).length;
    $('#med-count-badge').text(`${selectedCount}/${medicines.length}`);
    if (!medicines.length) {
        $('#medicine-list').html('<tr><td colspan="6" class="text-center text-muted py-3"><i class="fas fa-info-circle mr-2"></i>No medicines added yet</td></tr>');
        return;
    }
    let html = '';
    medicines.forEach((med, i) => {
        ...
        html += `<tr>
            <td><input type="checkbox" class="medicine-checkbox" data-index="${i}" ${med.selected ? 'checked' : ''}></td>
            ...
            <table style="width: 100%; border-collapse: collapse;">
                <tr>
                    ...
                    <td style="width: 50%; padding: 5px; vertical-align: top;">
                        ...
                        ${admissionMedicines.filter(med => med.selected).map((med, index) => `
...
function updateAdmissionMedicineList() {
    let selectedCount = admissionMedicines.filter(med => med.selected).length;
    $('#admission-med-count-badge').text(`${selectedCount}/${admissionMedicines.length}`);
    if (!admissionMedicines.length) {
        $('#admission-medicine-list').html('<tr><td colspan="6" class="text-center text-muted py-3"><i class="fas fa-info-circle mr-2"></i>No admission medicines added yet</td></tr>');
        return;
    }
    let html = '';
    admissionMedicines.forEach((med, i) => {
        let bc = med.order_type==='admission'?'badge-primary':'badge-info';
        html += `<tr>
            <td><input type="checkbox" class="admission-medicine-checkbox" data-index="${i}" ${med.selected ? 'checked' : ''}></td>
            <td>${med.name} ${med.strength?'<small class="text-muted">'+med.strength+'</small>':''}</td>
            <td>${med.dosage}</td>
            <td>${med.duration}</td>
            <td><span class="badge ${bc}">${med.order_type}</span></td>
...
function validateCurrentStep() {
    const rules = {
        2: { arr: diagnoses,          msg: 'Please add at least one diagnosis before proceeding' },
        3: { arr: investigations,     msg: 'Please add at least one investigation before proceeding' },
        4: { arr: advices,            msg: 'Please add at least one advice before proceeding' },
        // 5: { arr: freshPrescriptions, msg: 'Please add at least one fresh prescription before proceeding' }, // Removed validation
    };
...
function proceedToStep(step) {
    ...
    if (step <= 5) {
        ...
        currentStep = step;
        updateTabBadges();
        const names = ['','Admission Rx','Pre-operative Order','Post-operative Order','Fresh Prescription','Discharge'];
...
function activateTab(step) {
    ...
    // Automatically load sample data and show admission prescription when Admission Rx, Pre-op, Post-op, or Post-Operative order tabs are activated
...
function nextStep(step) {
    if (step === 1) {
        ...
        let selectedMedicines = medicines.filter(med => med.selected);
        if (!selectedMedicines.length) { toastr.error('Please select at least one medicine'); return; }
        if (!$('#surgery-type').val()) { toastr.error('Please enter surgery type'); return; }
        if (!$('#surgery-date').val()) { toastr.error('Please select surgery date'); return; }
            ...
            <tr>
                ...
                <td id="rx-body-left" style="width:37%; vertical-align:top; border-right:2px solid #005F02; padding:10px 10px 10px 5px; font-size:12px; background:#ADD8E6;">
                    ...
                    <div style="margin-bottom:18px;">
                        ...
                        <div style="margin-left:6px; line-height:1.8;">. Pulse &nbsp;&nbsp;&nbsp;&nbsp; <span style="font-weight:${pulse?'600':'400'}; color:${pulse?'#000':'#999'};">${pulse || ''}</span></div>
                        <div style="margin-left:6px; line-height:1.8;">. BP &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="font-weight:${bp?'600':'400'}; color:${bp?'#000':'#999'};">${bp || ''}</span></div>
                        <div style="margin-left:6px; line-height:1.8;">. Anaemia</div>
                        <div style="margin-left:6px; line-height:1.8;">. Jaundice</div>
                        <div style="margin-left:6px; line-height:1.8;">. Tem &nbsp;&nbsp;&nbsp;&nbsp; <span style="font-weight:${temp?'600':'400'}; color:${temp?'#000':'#999'};">${temp || ''}</span></div>
                        <div style="margin-left:6px; line-height:1.8;">. Oedema</div>
                        <div style="margin-left:6px; line-height:1.8;">. Weight &nbsp; <span style="font-weight:${wt?'600':'400'}; color:${wt?'#000':'#999'};">${wt || ''}</span></div>
                    ...
                    <!-- Surgery Info (small) -->
                    ${$('#surgery-type').val() ? `
                    <div style="margin-top:14px; padding-top:8px; border-top:1px dashed #ccc; font-size:11px; color:#555;">
                        <strong>Surgery:</strong> ${$('#surgery-type').val()}<br>
                        ${$('#anesthesia-type').val() ? '<strong>Anaesthesia:</strong> ' + $('#anesthesia-type').val() + '<br>' : ''}
                        ${$('#ward-bed').val() ? '<strong>Ward/Bed:</strong> ' + $('#ward-bed').val() : ''}
                    </div>` : ''}
                </td>
                ...
                <td style="width:63%; vertical-align:top; padding:10px 10px 10px 16px; font-size:13px;">
                    ...
                    <table style="width:100%; border-collapse:collapse; border:2px solid #005F02; margin-bottom:15px; font-size:12px;">
                        ...
                        <tbody>
                            ${(() => {
                                let selectedMeds = medicines.filter(med => med.selected);
                                console.log('displayReview - Total medicines:', medicines.length);
                                console.log('displayReview - Selected medicines:', selectedMeds.length);
                                return selectedMeds.length > 0 ? selectedMeds.map((m, idx) => {
                    ...
                    ${advices.length ? `
                        <div style="margin-top:18px;">
                            <div style="font-weight:700; text-decoration:underline; font-size:13px; margin-bottom:6px;">Advice:</div>
                            ${advices.map(a => `<div style="margin-left:8px; line-height:1.7;">• ${a.advice}</div>`).join('')}
                        </div>
                    ` : ''}
                    ...
                    ${$('#instructions').val() ? `
                        <div style="margin-top:18px;">
                            <div style="font-weight:700; text-decoration:underline; font-size:13px; margin-bottom:4px;">Instructions:</div>
                            <div style="margin-left:8px;">${$('#instructions').val()}</div>
                        </div>
                    ` : ''}
...
function printPrescription() {
    ...
    console.log('Total medicines in array:', medicines.length);
    console.log('Medicines array:', medicines);
    console.log('Selected medicines count:', selectedMedicines.length);
    console.log('Selected medicines array:', selectedMedicines);
    
    // Check each medicine's selected status
    medicines.forEach((med, index) => {
        console.log(`Medicine ${index}: "${med.name}" - selected: ${med.selected}`);
    });
    
    if (!selectedMedicines.length && !admissionMedicines.length) { toastr.error('No medicines selected for printing'); return; }
...
function saveToDatabase(showMessage = true) {
    ...
    let formData = {
        ...
        surgery_name: $('#surgery-type').val(),
        surgery_date: $('#surgery-date').val(),
        anesthesia_type: $('#anesthesia-type').val(),
        ward_bed: $('#ward-bed').val(),
        bp: $('#bp').val(), pulse: $('#pulse').val(),
        temperature: $('#temperature').val(), weight: $('#weight').val(),
